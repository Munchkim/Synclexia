...
const CustomDrawer: React.FC<DrawerContentComponentProps> = (props) => {
  ...
  return (
    <DrawerContentScrollView {...props} contentContainerStyle={[styles.container, { backgroundColor: bgColor }]}>
      {/* Header */}
      <TouchableOpacity style={styles.profile} onPress={() => props.navigation.navigate('Account')}>
      ...
      <TouchableOpacity style={styles.row} onPress={() => setShowFontSize(true)}>
        <View style={styles.iconWrapper}><FontAwesome5 name="text-height" size={20} color="#333" /></View>
      ...
      <TouchableOpacity style={styles.row} onPress={() => setShowFontStyle(true)}>
        <View style={styles.iconWrapper}><FontAwesome5 name="italic" size={20} color="#333" /></View>
      ...
      <TouchableOpacity style={styles.row} onPress={() => setShowBgColor(true)}>
        <View style={styles.iconWrapper}><Ionicons name="color-palette-outline" size={22} color="#333" /></View>
      ...
      {/* Pages */}
      <TouchableOpacity style={styles.row} onPress={() => props.navigation.navigate('Help')}>
      ...
      <TouchableOpacity style={styles.row} onPress={() => props.navigation.navigate('AboutUs')}>
      ...
      <TouchableOpacity style={styles.row} onPress={() => props.navigation.navigate('Feedback')}>
        <View style={styles.iconWrapper}><Ionicons name="chatbox-ellipses-outline" size={22} color="#333" /></View>
      ...
      >
        ...
        <Text style={[styles.item, { fontFamily, fontSize: fontSizeValue, fontWeight: 'bold' }]}>
          Logout
        </Text>
      </TouchableOpacity>
      ...
      <Modal visible={showFontSize} transparent animationType="fade">
        <View style={styles.centeredModal}>
          <View style={[styles.modalWide, { backgroundColor: bgColor }]}>
            ...
            <Text style={{ marginTop: 20, fontSize: fontSizeValue, fontFamily, textAlign: 'center', color: '#333' }}>
              This is sample.
            </Text>
